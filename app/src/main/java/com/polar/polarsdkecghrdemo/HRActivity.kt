...
class HRActivity : AppCompatActivity(), PlotterListener {
    companion object {
        private const val TAG = "HRActivity Test"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        api.setApiCallback(object : PolarBleApiCallback() {
            ...
            override fun hrNotificationReceived(identifier: String, data: PolarHrData.PolarHrSample) {
                //Toast.makeText(applicationContext, "pula mea", Toast.LENGTH_SHORT).show()
                //int hr = data.hr;
                //= sample.hr.toString()
            ...
            override fun polarFtpFeatureReady(identifier: String) {
                Toast.makeText(applicationContext, "pula mea 2", Toast.LENGTH_SHORT).show()
            }
